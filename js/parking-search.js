...
function initializeParkingSearch() {
    ...
    async function searchParkingSpaces(location) {
            ...
            'clayton': [
                {
                    ...
                    distance: '0.2 km',
                    price: '$3.50/hour',
                    coordinates: { lat: -37.9249, lng: 145.1340 }
                },
                {
                    ...
                    distance: '0.5 km',
                    price: '$2.00/hour',
                    coordinates: { lat: -37.9260, lng: 145.1350 }
                },
                {
                    ...
                    distance: '0.7 km',
                    price: '$4.00/hour',
                    coordinates: { lat: -37.9270, lng: 145.1360 }
                },
                {
                    ...
                    distance: '1.1 km',
                    price: '$5.00/hour',
                    coordinates: { lat: -37.9280, lng: 145.1370 }
                }
            ],
            'melbourne': [
                {
                ...
                {
                    name: 'Federation Square Garage',
                    availableSpaces: 15,
                    totalSpaces: 250,
                    address: '200 Flinders Street, Melbourne',
                    distance: '0.3 km',
                    price: '$6.50/hour',
                    coordinates: { lat: -37.8182, lng: 144.9696 }
                }
            ]
        };
        ...
        // Check if location matches any mock data
    ...
    function displayParkingResults(parkingData) {
        ...
        parkingData.forEach(parking => {
            const parkingItem = createParkingItem(parking);
    ...
    function createParkingItem(parking) {
        ...
        const availabilityClass = parking.availableSpaces > 20 ? 'success' : 
